...
import io.rx_cache2.internal.utils.Md5;
...
public final class Disk implements Persistence {
     ...
     */
    @Override
    public void saveRecord(String key, io.rx_cache2.internal.Record record, boolean isEncrypted,
                           String encryptKey) {
     ...
     */
    @Override
    public <T> io.rx_cache2.internal.Record<T> retrieveRecord(String key, boolean isEncrypted,
                                                              String encryptKey) {
        key = safetyKey(key);
    ...
    private String safetyKey(String key) {
        return Md5.encode(key.replaceAll("/", "_"));
    }
}