...
public class ProxyTranslatorTest {
  ...
  @Test public void Check_Basic_Method() throws NoSuchMethodException {
    Method mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocks", Observable.class);
  ...
  @Test public void Check_Method_With_Life_Time_Defined() throws NoSuchMethodException {
    Method mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksLifeTimeMinutes",
            Observable.class);
    ConfigProvider configProvider = proxyTranslatorUT.processMethod(mockMethod, dataMethod);
    assertThat(configProvider.getLifeTimeMillis(), is(60000l));

    mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksLifeTimeSeconds",
            Observable.class);
    configProvider = proxyTranslatorUT.processMethod(mockMethod, dataMethod);
    assertThat(configProvider.getLifeTimeMillis(), is(1000l));

    mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksLifeTimeMillis",
            Observable.class);
    configProvider = proxyTranslatorUT.processMethod(mockMethod, dataMethod);
  ...
  @Test public void When_Return_Response_Then_Required_Detail_Response_Is_True()
    ...
    Method mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksWithDetailResponse",
            Observable.class);
    ConfigProvider configProvider = proxyTranslatorUT.processMethod(mockMethod, dataMethod);
  ...
  public void When_Method_Not_Return_Observable_Then_Throw_Exception()
      throws NoSuchMethodException {
    Method mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksBadReturnType",
            Observable.class);
  ...
  @Test public void When_Evict_Cache_Dynamic_Key_Evict() throws NoSuchMethodException {
    ...
    Method mockMethod =
        io.rx_cache.internal.ProvidersRxCache.class.getDeclaredMethod("getMocksDynamicKeyEvictPage",
