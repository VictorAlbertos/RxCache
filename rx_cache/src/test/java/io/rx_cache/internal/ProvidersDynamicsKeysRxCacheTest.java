...
public class ProvidersDynamicsKeysRxCacheTest {
    ...
    private void populateFilterPage(String filter_page) {
        ...
        providersRxCache.getMocksFilteredPaginateEvict(Observable.just(mocksFilterPage), new DynamicKeyGroup(filter, page), new EvictDynamicKeyGroup(false)).subscribe(subscriber);
        subscriber.awaitTerminalEvent();
    }
    ...
    private void retrieveAndCheckFilterPageValue(String filter_page, boolean shouldThrowException) {
        ...
        providersRxCache.getMocksFilteredPaginateEvict(Observable.<List<Mock>>just(null), new DynamicKeyGroup(filter, page), new EvictDynamicKeyGroup(false)).subscribe(subscriber);
        subscriber.awaitTerminalEvent();
    ...
    private void evictProviderKey(String filter_page) {
        ...
        providersRxCache.getMocksFilteredPaginateEvict(Observable.<List<Mock>>just(null), new DynamicKeyGroup(filter, page), new EvictProvider(true)).subscribe(subscriber);
        subscriber.awaitTerminalEvent();
    }
    ...
    private void evictDynamicKey(String filter_page) {
        ...
        providersRxCache.getMocksFilteredPaginateEvict(Observable.<List<Mock>>just(null), new DynamicKeyGroup(filter, page), new EvictDynamicKey(true)).subscribe(subscriber);
        subscriber.awaitTerminalEvent();
    }
    ...
    private void evictDynamicKeyGroup(String filter_page) {
        ...
        providersRxCache.getMocksFilteredPaginateEvict(Observable.<List<Mock>>just(null), new DynamicKeyGroup(filter, page), new EvictDynamicKeyGroup(true)).subscribe(subscriber);
        subscriber.awaitTerminalEvent();
    }
